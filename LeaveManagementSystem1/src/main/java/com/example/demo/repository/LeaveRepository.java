...
//	
//
	List<Leave> findByRoleAndStatusInAndReportingmanager(String role, List<String> asList, String reportingmanager);

	List<Leave> findByRoleAndReportingmanager(String role, String reportingmanager);
