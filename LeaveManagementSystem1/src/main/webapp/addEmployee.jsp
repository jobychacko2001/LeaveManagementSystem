...
<body>
  ...
  <option value="" selected>choose reporting person</option> 
  ...
  <c:forEach items="${admin}" var="employee"> 
    <option value="${employee.name}">${employee.name} (Admin)</option>
          ...
          <div>
            <!-- <button type="submit" class="btn btn-dark btn-block Btn">Submit</button> -->
            <button type="submit" class="btn btn-dark btn-block Btn">Submit</button>
            <br>
          </div>
        </form>
      ...
      <script>
        ...
        // august = 08 .if the didgit is single it will add a zero to it.
        if (Jmonth < 10) {
          Jmonth = "0" + Jmonth
        }
        // if day is single digit it will add 0 to it eg:may 7 ==>07
        if (Jtdate < 10) {
          Jtdate = "0" + Jtdate;
        }
        if (Jnextmonth < 10) {
        ...
        console.log("current date"+JmaxDate);
        document.getElementById("hiringDate").setAttribute("max", JnextmaxDate);
        console.log("next month"+JnextmaxDate);
